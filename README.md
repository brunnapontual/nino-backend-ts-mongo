  <a href="https://nino-backend-ts-mongo.onrender.com/" target="_blank"> 
    <img src="https://img.shields.io/badge/Render-Online-46E062?logo=render&logoColor=white" alt="Status de Deploy" />
  </a>
  
# ![Logo](src/img/logo.png) 
### Bem-vindo ao Backend do Nino!   

Uma **API REST** construída com **Node.js** + **TypeScript** + **Express** + **MongoDB (Mongoose)**.   
Implementando operações CRUD e arquitetura modular para gerenciamento de dados da aplicação Nino. 🌐 [nino-react-native-front](https://github.com/mosiah-andrade/nino-react-native-front.git)    
...
Você pode acessá-la diretamente no link do ambiente de deploy: 
